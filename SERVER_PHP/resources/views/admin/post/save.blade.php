                ...
                <div class="col-12 bg-color-white shadows-1 px-3 py-3">
                    <section class="pb-4">
                        ...
                        <select name="type" class="js__single-select">
                            ...
                            value="{{ Config::get('constant.TYPE-POST.DEFAULT') }}">デフォルトのポスト</option>
                            <option @if(old('type', $post->type) == Config::get('constant.TYPE-POST.RIGHT')) {{ 'selected' }} @endif
                            value="{{ Config::get('constant.TYPE-POST.RIGHT') }}">右のポスト</option>
                            <option @if(old('type', $post->type) == Config::get('constant.TYPE-POST.LEFT')) {{ 'selected' }} @endif
                                value="{{ Config::get('constant.TYPE-POST.LEFT') }}">左のポスト</option>
                        </select>
                    </section>
                </div>
            </div>
